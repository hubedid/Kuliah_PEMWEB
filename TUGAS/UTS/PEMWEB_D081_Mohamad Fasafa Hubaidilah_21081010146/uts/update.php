  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <h2 style="margin: 30px 0 30px 0;">Update <?php echo ucwords(preg_replace("(_)", " ", $table)) ?></h2>
              ...
              // foreach($kolom as $atribut){ 
                ...
                if($rowCek != NULL){ ?>
                  <div class="form-group">
                    <label><?php echo ucwords(preg_replace("(_)", " ", $atribut['COLUMN_NAME'])); ?></label>
                    <select class="custom-select" name="<?php echo $atribut['COLUMN_NAME']; ?>" required="required" <?php echo isset($_GET[$atribut['COLUMN_NAME']]) ? "disabled" : "" ?>>
                      ...
                      <?php 
                        ...
                        while ($rowDropdown = mysqli_fetch_array($rDropdown)) {?>
                          <option value="<?php echo $rowDropdown[$rowCek['REFERENCED_COLUMN_NAME']]; ?>" <?php echo $data[$atribut['COLUMN_NAME']]==$rowDropdown[$rowCek['REFERENCED_COLUMN_NAME']] ? "selected" : "" ?> ><?php echo $rowDropdown[$rowCek['REFERENCED_COLUMN_NAME']].". ".$rowDropdown[$rowGetSecondColumn['COLUMN_NAME']]; ?></option>
                        <?php } ?>
                    </select>
                  </div>
              <?php } else{ ?>

          ...
          <div class="table-responsive">
            <table class="table table-striped table-sm">
              ...
              <?php 
                  ...
                  //siapkan query SQL
                  $query = "SELECT * FROM kondektur ORDER BY id_kondektur ASC";
                 ...
                 <?php while($data = mysqli_fetch_array($result)): ?>
                    ...
                    if(isset($_GET['filter'])){
                        $queryKmkondektur = "SELECT SUM(jumlah_km) AS total_km FROM trans_upn WHERE id_kondektur = $data[id_kondektur] AND MONTH(tanggal) = '$_GET[filter]' GROUP BY id_kondektur";
                    }else{
                    ...
                    if($data_km_kondektur != NULL){
                        ...
                        $kmGaji = 1500;
                        $gaji_kondektur = $total_km * $kmGaji;
                    ?>
                    <tr>

<?php 
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
      $q = "SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'classicmodels' AND TABLE_NAME = 'customers'";
    ...
    <div class="container-fluid">
      <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column" style="margin-top:100px;">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="<?php echo "form.php"; ?>">Tambah Data Customer</a>
              </li>
              <li class="nav-item">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <h2 style="margin: 30px 0 30px 0;">Form Kustomer</h2>

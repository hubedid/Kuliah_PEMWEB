            ...
            <div class="kotakinfo">
              <table style="position: relative">
                ...
                <tr>
                  ...
                  <td><p><?php echo (empty($_POST['tanggal_lahir'])) ? '<form action="#profile" method="post"><label for="tanggal_lahir">Tanggal Lahir : </label><input type="text" name="tanggal_lahir"><input type="submit" value="Submit"></form>' : date_diff(date_create($_POST['tanggal_lahir']), date_create('now'))->y // date("Y")-$_POST['tahun_lahir'] ?></p></td>
                </tr>
                <tr>
                  <td>
                    <b><p>GENDER :</p></b>
                  ...
                  <div class="baris kotak4">
                    <div class="kotak14">
                      <div class="baris kotak15">
                        <div class="kolom">
                          <h3 class="h3skill" align="left">HTML</h3>
                        </div>
                        <div class="kolom">
                          <h3 class="h3skill" align="right">50%</h3>
                        </div>
                      </div>
                      <div class="baris kotakskill">
                        <hr class="barskill" style="width: 50%" />
                        <hr class="garisskill" style="width: 50%" />
                      </div>
                    </div>
                  </div>
                  <div class="baris kotak4">
